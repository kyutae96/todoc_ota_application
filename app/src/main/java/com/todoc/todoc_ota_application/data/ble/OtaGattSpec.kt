...
object OtaGattSpec {
    val SERVICE_OTA: UUID = UUID.fromString("6e400001-b5a3-f393-e0a9-e50e24dcca9e")
    ...
    val QUALCOMM_UUID = UUID.fromString("00001100-d102-11e1-9b23-00025b00a5a5")
    val GaiaCommand_UUID = UUID.fromString("00001101-d102-11e1-9b23-00025b00a5a5")
    val GaiaResponse_UUID = UUID.fromString("00001102-d102-11e1-9b23-00025b00a5a5")
    val GaiaData_UUID = UUID.fromString("00001103-d102-11e1-9b23-00025b00a5a5")


    val BATTERY_UUID = UUID.fromString("0000180f-0000-1000-8000-00805f9b34fb")
